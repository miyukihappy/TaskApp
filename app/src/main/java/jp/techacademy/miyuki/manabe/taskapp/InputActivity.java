...
public class InputActivity extends AppCompatActivity {
    ...
    protected void onCreate(Bundle savedInstanceState) {
        ...
        Button fab = (Button) findViewById(R.id.add_category_button);
        fab.setOnClickListener(new View.OnClickListener() {
            @Override
            public void onClick(View view) {
                Intent intent = new Intent(InputActivity.this, AddCategoryActivity.class);
        ...
        spinner.setOnItemSelectedListener(new AdapterView.OnItemSelectedListener() {
            ...
            public void onItemSelected(AdapterView<?> parent, View view,
                ...
                if(!spinner.getSelectedItem().equals("")){
                    ...
                    selectCategoryId = Integer.parseInt(item.substring(0,item.indexOf(" : ")));
                }
            }
            @Override
    ...
    private void addTask() {
        ...
        Realm realmCategory = Realm.getDefaultInstance();
        Category category = realmCategory.where(Category.class).equalTo("id", selectCategoryId).findFirst();
